...
import { AlertTriangle, Clock, BarChart2, Users, QrCode, RefreshCw, CheckCircle, XCircle } from 'lucide-react';
...
export default function AdminDashboard() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            // Ambil Data Cuti (INI YANG DIKEMBALIKAN)
    ...
    // 3. Handle Approve/Reject Cuti
    const handleStatusChange = async (id: number, newStatus: string) => {
        const aksi = newStatus === 'approved' ? 'menyetujui' : 'menolak';
        if (!confirm(`Yakin ingin ${aksi} pengajuan ini?`)) return;
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* 3. TABEL APPROVAL CUTI (Kanan - INI YANG DIKEMBALIKAN) */}
